      ...
      <div className={classes["customer-reviews"]}>
        <div className={classes["review"]}>
          <div className={classes["review-text"]}>
            Good morning, China. Now I have bing chilling. I like bing chilling
            very much, but "Fast and Furious 9" is better than bing chilling. 🍦
          </div>
        ...
        <div className={classes["review"]}>
          <div className={classes["review-text"]}>
            If someone were to harm my family or a friend or somebody I love, I
            would eat them. I might end up in jail for 500 years, but I would
            eat them.
          </div>
          <div className={classes["reviewer"]}>
            <div className={classes["reviewer-image"]}>
